...
export default function BlogCard({ post, index = 0 }) {
  return (
    ...
    >
      {/* Top visual strip */}
      <div className="relative flex h-36 items-center justify-center overflow-hidden bg-sea-950 border-b border-hairline">
        ...
        <span className="relative z-10 inline-flex items-center gap-1.5 rounded-full border border-cyan-500/30 bg-cyan-500/10 px-3.5 py-1.5 text-xs font-bold uppercase tracking-wider text-cyan-300">
